...
def get_playlist_by_id(playlist_url, sp=sp):
    ...
    save_playlist(playlist_name=playlist_name, owner_name=owner_name, tracks=playlist['tracks']['items'], id_playlist=playlist_id)
...
def save_playlist(playlist_name, owner_name, tracks, id_playlist):
    ...
    for track in tracks:
        new_track = Track(
            ...
            track_name=track['track']['name'], duration=track['track']['duration_ms'])
...
if __name__ == "__main__":
    ...
    playlist = get_playlist_by_id(sp=sp, playlist_url=playlist_url)
    # tracks = get_track_artist_list(playlist=playlist)
